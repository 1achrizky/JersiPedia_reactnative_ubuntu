import {
    ChelseaDepan, ChelseaBelakang,
    DortmundDepan, DortmundBelakang,
    JuveDepan, JuveBelakang,
    LeicesterDepan, LeicesterBelakang,
    LiverpoolDepan, LiverpoolBelakang,
    MadridDepan, MadridBelakang,
    MilanDepan, MilanBelakang,
    MunchenDepan, MunchenBelakang, 
		PremierLeague, BundesLiga, SerieA, LaLiga
}
from '../../assets'
